# Generated by Django 3.2 on 2023-05-07 14:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('signed', '已报名'), ('unregistered', '未报名'), ('graduated', '已毕业'), ('drop-off', '已退学')], max_length=64)),
                ('date', models.DateField(auto_now_add=True, verbose_name='咨询日期')),
                ('class_list', models.ManyToManyField(blank=True, null=True, to='crm.ClassList')),
            ],
        ),
        migrations.CreateModel(
            name='School',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.userprofile')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
