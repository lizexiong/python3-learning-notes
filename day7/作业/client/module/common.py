...
def print_process(total_size,curr_size):
    """
    打印进度条，打印66个#
    :param totalsize:
    :param curr_size:
    :return:
    """
    c = int((curr_size / total_size) * 66)
    p = int((curr_size / total_size) * 100)
    j = "#" * c
