# Generated by Django 3.2 on 2023-05-22 08:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('triggers', models.ManyToManyField(blank=True, to='Robb.Trigger', verbose_name='触发器列表')),
            ],
        ),
        migrations.AddField(
            model_name='service',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Robb.trigger')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_groups', models.ManyToManyField(blank=True, to='Robb.HostGroup')),
                ('hosts', models.ManyToManyField(blank=True, to='Robb.Host')),
                ('operations', models.ManyToManyField(to='Robb.ActionOperation')),
                ('triggers', models.ManyToManyField(blank=True, help_text='想让哪些trigger触发当前报警动作', to='Robb.Trigger')),
            ],
        ),
    ]
