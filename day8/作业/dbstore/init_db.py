...
hosts = {
    "G01": [{"HIP": "172.21.161.149", "HNAME": "agent", "HUSER": "root", "PORT": "22", "AUTH_TYPE": 1, "HKEY": "huawei"},
            {"HIP": "172.21.161.161", "HNAME": "ubuntu", "HUSER": "root", "PORT": "22", "AUTH_TYPE": 1,"HKEY": "huawei"}, ],
    "G02": [{"HIP": "172.21.161.112", "HNAME": "agent", "HUSER": "root", "PORT": "22", "AUTH_TYPE": 2,"HKEY": "private_test03.rsa"}, ],
    "G03": [{"HIP": "172.21.161.113", "HNAME": "ubuntu", "HUSER": "super", "PORT": "22", "AUTH_TYPE": 1, "HKEY": "test"}, ],
    "G04": [{"HIP": "172.21.161.114", "HNAME": "agent", "HUSER": "root", "PORT": "22", "AUTH_TYPE": 1, "HKEY": "redhat"}, ]
}
users = {
    "admin": {"UPASS": "huawei", "GID": "G01,G02,G03,G04", "UROLE": "admin", "NAME": "administrator"},
    "lizexiong": {"UPASS": "huawei", "GID": "G01,G02", "UROLE": "user", "NAME": "lizexiong"}
}
